...
Alloy.Globals.windowStack.push($.twentyThirdScreen);

var radioButton	= require('/RadioOptions');
var buttonBack = $.headerView.getView('backView');
buttonBack.addEventListener('click', function(e){
	$.twentyThirdScreen.close();	
});
...
function openNextScreen(e){
	...
	Alloy.Globals.dataToCapture.consume_on_mobile = radioGroup2.selectedSaveValue;
	Alloy.createController("TwentyFourthScreen").getView().open();

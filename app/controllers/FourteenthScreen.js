...
Alloy.Globals.windowStack.push($.fourteenthScreen);

var radioButton	= require('/RadioOptions');
var buttonBack = $.headerView.getView('backView');
buttonBack.addEventListener('click', function(e){
	$.fourteenthScreen.close();	
});
...
var radioGroup2 = radioButton.createGroup({
	...
	height:150,
	layout:'vertical',
	radioItemsValue:[L("yes"),L("no"),L("dont_know")],
	radioItemsSaveValue:["yes", "no", "dont_know"],
...
function openNextScreen(e){
	...
	Alloy.Globals.dataToCapture.own_hd_tv = radioGroup2.selectedSaveValue;

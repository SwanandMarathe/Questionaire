...
Alloy.Globals.windowStack.push($.twentySecondScreen);

var radioButton	= require('/RadioOptions');
var buttonBack = $.headerView.getView('backView');
buttonBack.addEventListener('click', function(e){
	$.twentySecondScreen.close();	
});
...
function openNextScreen(e){
	...
	Alloy.Globals.dataToCapture.consume_on_tv = radioGroup2.selectedSaveValue;
	Alloy.createController("TwentyThirdScreen").getView().open();

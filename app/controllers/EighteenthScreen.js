...
var radioGroup2 = radioButton.createGroup({
	...
	height:150,
	layout:'vertical',
	radioItemsValue:[L("broadband"),L("dongle")],
	radioItemsSaveValue:[L("broadband"),L("dongle")],
...
function openNextScreen(e){
	...
	Alloy.Globals.dataToCapture.typeof_internet_connection = radioGroup2.selectedSaveValue;

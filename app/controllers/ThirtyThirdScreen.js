...
var args = $.args;
$.thirtyThirdScreen.windowSoftInputMode = Titanium.UI.Android.SOFT_INPUT_STATE_VISIBLE;
setTimeout(function(){$.txtSubId.focus();},100);

Alloy.Globals.windowStack.push($.thirtyThirdScreen);

var buttonBack = $.headerView.getView('backView');
buttonBack.addEventListener('click', function(e){
	$.thirtyThirdScreen.close();	
});
...
function openNextScreen(e){
	...
	Alloy.Globals.dataToCapture.newspaper_read_name = $.txtSubId.value;
	Alloy.createController("ThirtyFourthScreen").getView().open();

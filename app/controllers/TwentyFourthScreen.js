...
Alloy.Globals.windowStack.push($.twentyFourthScreen);

var radioButton	= require('/RadioOptions');
var buttonBack = $.headerView.getView('backView');
buttonBack.addEventListener('click', function(e){
	$.twentyFourthScreen.close();	
});
...
function openNextScreen(e){
	...
	Alloy.Globals.dataToCapture.consume_on_laptop = radioGroup2.selectedSaveValue;
	Alloy.createController("TwentyFifthScreen").getView().open();
